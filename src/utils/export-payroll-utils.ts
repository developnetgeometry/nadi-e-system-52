...
export const filterPayrollData = (
  ...
  return data.filter(record => {
    ...
    const matchesMinPayment = paymentRangeMin === undefined || payment >= paymentRangeMin;
    const matchesMaxPayment = paymentRangeMax === undefined || payment <= paymentRangeMax;
    
    return matchesSearch && matchesPosition && matchesStatus && matchesMinPayment && matchesMaxPayment;
  });
};
