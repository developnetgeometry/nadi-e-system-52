...
export const useNotifications = ({
  ...
  // Fetch notifications
  const { data: notifications, error, isLoading: fetchLoading } = useQuery({
  ...
  const sendTestEmailNotification = async (email: string, subject: string, message: string) => {
    try {
      setIsLoading(true);
  ...
  const sendTestPushNotification = async (userId: string, title: string, body: string) => {
    try {
      setIsLoading(true);
