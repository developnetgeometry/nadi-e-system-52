            ...
            <TableBody>
              {templates.map((template) => (
                <TableRow key={template.id}>
                  ...
                  <TableCell>
                    <span className={`capitalize px-2 py-1 rounded-full text-xs bg-${template.type === 'info' ? 'blue' : template.type === 'success' ? 'green' : template.type === 'warning' ? 'yellow' : 'red'}-100 text-${template.type === 'info' ? 'blue' : template.type === 'success' ? 'green' : template.type === 'warning' ? 'yellow' : 'red'}-700`}>
                      {template.type}
                    </span>
                  </TableCell>
                  <TableCell>
