...
const PILLARS = [
  { value: "technical-1", label: "Programming & Development", categoryId: "technical" },
  { value: "technical-2", label: "Network & Security", categoryId: "technical" },
  ...
  { value: "digital-2", label: "Internet & Social Media", categoryId: "digital" },
  { value: "entrepreneur-1", label: "Business Planning", categoryId: "entrepreneurship" },
  { value: "entrepreneur-2", label: "Marketing", categoryId: "entrepreneurship" }
];

const PROGRAMMES = [
  { value: "web-dev", label: "Web Development Fundamentals", pillarId: "technical-1" },
  { value: "mobile-dev", label: "Mobile App Development", pillarId: "technical-1" },
  { value: "cyber-security", label: "Cybersecurity Basics", pillarId: "technical-2" },
  { value: "network-admin", label: "Network Administration", pillarId: "technical-2" },
  ...
  { value: "project-management", label: "Project Management", pillarId: "soft-2" },
  ...
  { value: "social-media", label: "Social Media for Business", pillarId: "digital-2" },
  { value: "online-research", label: "Online Research Techniques", pillarId: "digital-2" },
  { value: "business-plan", label: "Business Plan Creation", pillarId: "entrepreneur-1" },
  { value: "financial-planning", label: "Financial Planning", pillarId: "entrepreneur-1" },
  { value: "digital-marketing", label: "Digital Marketing", pillarId: "entrepreneur-2" },
  { value: "branding", label: "Branding Strategy", pillarId: "entrepreneur-2" }
];

const MODULES = [
  { value: "html-css", label: "HTML & CSS Basics", programmeId: "web-dev" },
  { value: "javascript", label: "JavaScript Fundamentals", programmeId: "web-dev" },
  { value: "react-intro", label: "Introduction to React", programmeId: "web-dev" },
  { value: "android-basics", label: "Android Development Basics", programmeId: "mobile-dev" },
  { value: "ios-basics", label: "iOS Development Basics", programmeId: "mobile-dev" },
  { value: "react-native", label: "React Native Development", programmeId: "mobile-dev" }
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium flex items-center">
                  <Category className="h-5 w-5 mr-2" />
                  Categorization
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <FormField
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input placeholder="e.g. Kuala Lumpur" className="pl-8" {...field} />
                            </div>
                          </FormControl>
                          <FormDescription>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input placeholder="Enter trainer name" className="pl-8" {...field} />
                          </div>
                        </FormControl>
                        <FormDescription>
              ...
              <div className="space-y-4">
                ...
                <div className="border border-dashed rounded-lg p-6">
                  <div className="flex flex-col items-center justify-center gap-4">
                    <FileUpload className="h-10 w-10 text-gray-400" />
