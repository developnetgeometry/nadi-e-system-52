...
const programmeStatusData = [
  ...
  { status: "Request Approval", count: 1, color: "bg-yellow-100 text-yellow-700" },
...
const ProgrammesDashboard = () => {
  ...
  const userRole = "SSO Admin"; // Get this from user metadata or profile

  const getStatusBadge = (status: string) => {
    switch (status) {
      case "Draft":
        return <Badge className="bg-gray-200 text-gray-700 hover:bg-gray-300">Draft</Badge>;
      case "Request Approval":
        return <Badge className="bg-yellow-100 text-yellow-700 hover:bg-yellow-200">Request Approval</Badge>;
      case "Registered":
        return <Badge className="bg-purple-100 text-purple-700 hover:bg-purple-200">Registered</Badge>;
      case "Completed":
      ...
      <PageContainer>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card className="shadow-sm">
            <CardContent className="p-6">
              <h3 className="text-lg font-medium mb-4">Program Status Overview</h3>
