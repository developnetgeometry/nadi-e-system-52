...
const ProgrammeOthers = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "registered":
        return <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-200">Registered</Badge>;
      case "active":
    ...
    <DashboardLayout>
      <ErrorBoundary FallbackComponent={ErrorFallback}>
        <div className="container mx-auto py-6">
          <h1 className="text-2xl font-bold mb-6">Other Programs</h1>
          
          <Card className="mb-8">
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">Smart Services Others</CardTitle>
            </CardHeader>
            <CardContent>
...
export default ProgrammeOthers;
